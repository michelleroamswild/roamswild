-- Surface outside_public_land_polygon through get_dispersed_spots so the
-- explore map and the admin spot-review page can render it as a red flag.
-- Otherwise identical to 20260216_get_dispersed_spots_edge_flag.
