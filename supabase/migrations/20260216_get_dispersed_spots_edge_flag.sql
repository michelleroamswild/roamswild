-- Surface near_public_land_edge + meters_from_public_land_edge from spots.extra
-- through the get_dispersed_spots RPC so the explore page can render edge-
-- flagged spots in red. Adds two new return columns; otherwise identical
-- to 20260197_get_dispersed_spots_access_road.
