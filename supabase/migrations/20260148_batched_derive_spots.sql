-- Batched version of derive_spots_from_linked_roads that processes in chunks
-- to avoid statement timeout

CREATE OR REPLACE FUNCTION derive_spots_batch(
    p_north NUMERIC,
    p_south NUMERIC,
    p_east NUMERIC,
    p_west NUMERIC,
        ...
        IF NOT EXISTS (
            ...
            VALUES (
                ...
                25 + CASE WHEN rec.best_vehicle_access IN ('high_clearance', '4wd') THEN 10 ELSE 0 END +
                     CASE WHEN rec.road_names IS NOT NULL THEN 5 ELSE 0 END,
...
GRANT EXECUTE ON FUNCTION derive_spots_batch TO service_role;
