-- Function to get road segments within a radius for map rendering
-- Returns coordinates as JSON array for frontend consumption
...
BEGIN
    -- Create center point and convert radius
...
GRANT EXECUTE ON FUNCTION get_road_segments TO anon;
GRANT EXECUTE ON FUNCTION get_road_segments TO authenticated;
GRANT EXECUTE ON FUNCTION get_road_segments TO service_role;
