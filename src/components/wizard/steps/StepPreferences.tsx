  ...
  return (
    <div className="space-y-8">
      <div className="text-center">
        <Mono className="text-pine-6">Preferences</Mono>
        <h2 className="font-sans font-bold tracking-[-0.025em] text-ink text-[28px] md:text-[34px] leading-[1.1] mt-2">
          What kind of trip person are you?
        </h2>
        <p className="text-[15px] text-ink-3 mt-2">
          Set your interests, pace, and rig — we'll use these to surface the right activities at each destination.
        </p>
      </div>
