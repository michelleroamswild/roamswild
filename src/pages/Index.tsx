...
import { Path, Calendar, Clock, MapPinArea, CaretRight } from "@phosphor-icons/react";
          ...
          <div className="container px-4 md:px-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              {savedTrips.slice(0, 3).map((trip) => (
                <Card
                  key={trip.id}
                  className="group hover:shadow-[0_8px_30px_rgba(0,0,0,0.3)] transition-all duration-300 cursor-pointer h-full bg-card border-border"
